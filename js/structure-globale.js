...
function genererHeader(chemin) {
    ...
    const headerHTML = `
        ${lienSaut}
        <header>
            <a class="titre-nom" href="${chemin}index.html"><img src="${chemin}assets/Logo_portfolio.png" alt="" class="logo-header" width="50" height="50"><span class="titre-texte">Justine BLIN</span></a>
