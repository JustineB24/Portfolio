function genererHead(chemin) {
    const headHTML = `
        ...
        <link rel="shortcut icon" type="image/x-icon" href="${chemin}assets/Logo_portfolio.png" alt="Logo Justine BLIN">
...
function genererHeader(chemin) {
    const headerHTML = `
        <header>
            <a class="titreNom" href="${chemin}index.html">Justine BLIN</a>
            <!-- Conteneur des boutons réseaux sociaux -->
            <div class="reseaux">
                <!-- From Uiverse.io by wilsondesouza -->
                <a href="https://www.linkedin.com/in/justine-blin-a88600292" target="_blank" aria-label="Profil LinkedIn">
                    <button class="btnReseaux" id="linkedin">
                        <svg class="svgIcon" viewBox="0 0 16 16" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <a href="https://github.com/JustineB24" target="_blank" aria-label="Profil GitHub">
                    <button class="btnReseaux" id="github">
...
function genererFooter(chemin) {
    const footerHTML = `
        <footer id="footer">
            <div id="copyright">
                &copy; <span id="year"></span> <strong> Designed by BLIN Justine.</strong> Tous droits réservés.
            </div>
            <div id="mentions-legales">
                <a id="mentions" href="${chemin}pages/mentions-legales.html">Mentions légales</a>
            </div>
        </footer>
    `;
    ...
    // Ajout automatique des scripts communs (theme.js et menu-burger.js)
    const scripts = ['theme.js', 'menu-burger.js'];
    scripts.forEach(scriptName => {
        const script = document.createElement('script');
        script.src = `${chemin}js/${scriptName}`;
